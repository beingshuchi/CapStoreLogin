...
SportsService service=ctx.getBean("service",SportsServiceImpl.class);
...
System.out.println("================================================================");
SportsService service1=ctx.getBean("service",SportsServiceImpl.class);
if(service==service1) {
...
System.out.println("================================================================");
String dname1="Day 4";
Day dd1=service.findByDayName(dname1);
for (Games l : dd1.getGames()) {
